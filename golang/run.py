...
def setup():
    ...
    with open('setup.log', 'w') as logFile:
        ...
        [subprocess.call(["go", "get", package], stdout = logFile) for package in dependencies]
        [subprocess.call(["go", "install", package], stdout = logFile) for package in dependencies]
